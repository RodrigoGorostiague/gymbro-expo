...
function RoutineCard({ entry, routineRef, resolvePlannedRoutine, onExecute, continueActiveWorkout, theme }: { entry: Extract<MesocycleScheduleProjectionEntry, { kind: 'routine' }>; routineRef: PlannedSessionRef; resolvePlannedRoutine: (ref: PlannedSessionRef) => { id: string } | undefined; onExecute: (weekNumber: number, entryId: string, routineId: string) => void; continueActiveWorkout: boolean; theme: { primary: string; secondary: string; text: string; textMuted: string; onPrimary: string; glass: string; glassBorder: string } }) {
