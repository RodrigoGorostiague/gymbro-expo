...
const styles = StyleSheet.create({
    overview: {
        ...
        borderBottomWidth: StyleSheet.hairlineWidth, gap: 10, paddingVertical: 14
    }, exerciseHeader: {
        ...
        alignItems: 'center', borderRadius: 12, borderWidth: 1, flexDirection: 'row', gap: 8, paddingHorizontal: 10, paddingVertical: 9
    }, setLabel: {
