...
select throws_like($$select public.create_workout_recap('{"routine_name":"Upper","completed_at":"2026-08-01T10:00:00Z","duration_seconds":1,"exercise_count":1,"metrics":{},"exercise_details":{"exercises":[{"name":"Bench","muscle_group_ids":[]}]},"share_payload":{"version":1,"routine":{"id":"private"}},"publication_key":"invalid-template"}'::jsonb)$$, 'invalid recap share payload', 'template payload rejects internal identifiers and unexpected fields');
select throws_like($$select public.create_workout_recap('{"routine_name":"Upper","completed_at":"2026-08-01T10:00:00Z","duration_seconds":1,"exercise_count":1,"metrics":{},"exercise_details":{"exercises":[{"name":"Bench","muscle_group_ids":[]}]},"share_payload":{"version":1,"routine":{"name":"Upper","muscleGroups":["pecho"],"exercises":[{"name":"Bench","muscleGroups":["pecho"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[{"id":"local-set","tipo":"C","weight":80,"reps":8}]}]}},"publication_key":"invalid-template-id"}'::jsonb)$$, 'invalid recap share payload', 'nested template sets reject internal IDs');
select throws_like($$select public.create_workout_recap('{"routine_name":"Upper","completed_at":"2026-08-01T10:00:00Z","duration_seconds":1,"exercise_count":1,"metrics":{},"exercise_details":{"exercises":[{"name":"Bench","muscle_group_ids":[]}]},"share_payload":{"version":1,"routine":{"name":"Upper","muscleGroups":["pecho"],"exercises":[{"name":"Bench","muscleGroups":["pecho"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[{"tipo":"C","weight":"private","reps":8}]}]}},"publication_key":"invalid-template-shape"}'::jsonb)$$, 'invalid recap share payload', 'nested template primitive types are validated');
select throws_like($$select public.create_workout_recap('{"routine_name":"Upper","completed_at":"2026-08-01T10:00:00Z","duration_seconds":1,"exercise_count":1,"metrics":{},"exercise_details":{"exercises":[{"name":"Bench","muscle_group_ids":[]}]},"share_payload":{"version":1,"routine":{"name":"Upper","muscleGroups":["pecho"],"exercises":[{"name":"Bench","muscleGroups":["pecho"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[null]}]}},"publication_key":"invalid-template-null-set"}'::jsonb)$$, 'invalid recap share payload', 'template payload rejects null set entries');
select throws_like($$select public.create_workout_recap('{"routine_name":"Upper","completed_at":"2026-08-01T10:00:00Z","duration_seconds":1,"exercise_count":1,"metrics":{},"exercise_details":{"exercises":[{"name":"Bench","muscle_group_ids":[]}]},"share_payload":{"version":"1","routine":{"name":"Upper","muscleGroups":["pecho"],"exercises":[{"name":"Bench","muscleGroups":["pecho"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[{"tipo":"C","weight":80,"reps":8}]}]}},"publication_key":"invalid-template-version"}'::jsonb)$$, 'invalid recap share payload', 'template version must be JSON number one');
select throws_like($$select public.create_workout_recap('{"routine_name":"Upper","completed_at":"2026-08-01T10:00:00Z","duration_seconds":1,"exercise_count":1,"metrics":{},"exercise_details":{"exercises":[{"name":"Bench","muscle_group_ids":[]}]},"share_payload":{"version":1,"routine":{"name":"Upper","muscleGroups":["pecho"],"exercises":[{"name":"Bench","muscleGroups":["pecho"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[{"tipo":"C","weight":80,"reps":8}]}]},"mesocycle":{"name":"Plan","goal":"Goal","durationWeeks":1,"routines":[{"name":"Upper","muscleGroups":["pecho"],"exercises":[{"name":"Bench","muscleGroups":["pecho"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[{"tipo":"C","weight":80,"reps":8}]}]}],"weeks":[[{"routineIndex":0,"progressionNote":"private"}]]}},"publication_key":"invalid-template-note"}'::jsonb)$$, 'invalid recap share payload', 'template payload rejects private progression notes');
select lives_ok($$select public.create_workout_recap('{"routine_name":"Shared template","completed_at":"2026-08-01T10:30:00Z","duration_seconds":3600,"exercise_count":1,"metrics":{"volume":1200},"exercise_details":{"exercises":[{"name":"Bench press","muscle_group_ids":["pecho","tríceps"]}]},"share_payload":{"version":1,"routine":{"name":"Shared template","muscleGroups":["pecho","tríceps"],"exercises":[{"name":"Bench press","muscleGroups":["pecho","tríceps"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[{"tipo":"C","weight":80,"reps":8}]}]},"mesocycle":{"name":"Strength plan","goal":"Build strength","durationWeeks":1,"routines":[{"name":"Shared template","muscleGroups":["pecho","tríceps"],"exercises":[{"name":"Bench press","muscleGroups":["pecho","tríceps"],"loadMode":"external-load","loadUnit":"kg","variant":"barbell","sets":[{"tipo":"C","weight":80,"reps":8}]}]}],"weeks":[[{"routineIndex":0,"dayLabel":"Monday"}]]},"performedSets":[{"exerciseIndex":0,"sets":[{"weight":80,"reps":8,"completed":true}]}]},"publication_key":"shared-template"}'::jsonb)$$, 'author can create a recap with a complete optional share payload');
