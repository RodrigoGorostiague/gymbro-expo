...
insert into public.training_states (owner_id, attempts) values ('60000000-0000-0000-0000-000000000002', '[{"id":"attempt-1","version":1,"owner":"60000000-0000-0000-0000-000000000002","recordedRoutineName":"Upper","completedAt":"2026-08-01T10:00:00Z","durationSeconds":60,"restTimerSeconds":0,"completion":{"validSets":1,"plannedSets":1,"adherence":1,"displayPercent":100,"status":"fully-completed"},"reward":{"setGems":0,"completionGems":0,"fullCompletionBonus":0,"totalGems":0,"qualifiesForCompletion":false},"rewardApplication":{"id":"receipt-1","state":"pending"},"exercises":[{"exerciseId":"EX-0001","recordedName":"Press","catalog":{"muscleParticipations":[{"muscleGroupId":"GM-902","relevance":1}]},"sets":[{"result":{"performed":true}}]}]},{"id":"attempt-2","version":1,"owner":"60000000-0000-0000-0000-000000000002","recordedRoutineName":"Upper","completedAt":"2026-08-02T10:00:00Z","durationSeconds":60,"restTimerSeconds":0,"completion":{"validSets":1,"plannedSets":1,"adherence":1,"displayPercent":100,"status":"fully-completed"},"reward":{"setGems":0,"completionGems":0,"fullCompletionBonus":0,"totalGems":0,"qualifiesForCompletion":false},"rewardApplication":{"id":"receipt-2","state":"pending"},"exercises":[{"exerciseId":"EX-0001","recordedName":"Press","catalog":{"muscleParticipations":[{"muscleGroupId":"GM-902","relevance":1}]},"sets":[{"result":{"performed":true}}]}]}]'::jsonb);

set local role authenticated;
select set_config('request.jwt.claim.sub', '60000000-0000-0000-0000-000000000001', true);
select is((select (entry.value ->> 'value')::numeric from jsonb_array_elements(public.get_social_profile_insights('60000000-0000-0000-0000-000000000002') -> 'muscle_distribution') entry(value) where entry.value ->> 'id' = 'GM-901'), 2::numeric, 'accepted connection receives weighted parent stimulus from repeated attempts');
