-- An authorized recap reader may open its author's public profile without deriving identity from an alias.
...
begin
  ...
  select jsonb_build_object(
    'id', recap.id, 'author_profile_id', recap.author_id, 'author_alias', profile.alias, 'author_avatar_id', profile.avatar_id,
